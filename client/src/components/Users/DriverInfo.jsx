  ...
  <div>
    ...
    <Segment padded="very">
      ...
      <Form.Group >
        ...
        <Form.Field disabled={props.disabled} onChange={props.onChange} name='dob' id='form-input-control-dob' control={Input} label='DOB' 
          placeholder='yyyy-mm-dd' width="3" value={props.user.dob || ''} />
      </Form.Group>
      <Form.Group>
      ...
      <Form.Group>
        <Form.Field disabled={props.disabled} onChange={props.onChange} name='address' id='form-input-control-address' control={Input} label='Street Address' 
          placeholder='address' width="3" value={props.user.address || ''} />
